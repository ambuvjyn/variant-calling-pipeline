...
echo "ID,# reads,aligned reads,% aligned,aligned bases,read length,% paired, %dup, mean insert size,# SNPs,# filtered SNPs,# SNPs post-bqsr,# SNPs filtered post-bqsr,average coverage"
